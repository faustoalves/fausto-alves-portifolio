  ...
  return (
    <div className="w-full h-full py-12 flex flex-col items-center justify-center ">
      <motion.div
        ...
        transition={{ duration: 1.7, ease: "easeIn", delay: 1 }}
        className="w-full px-24 grid grid-cols-3 gap-1.5 mx-auto"
      >
...
const WorkDetailContentTrack = ({
  ...
  return (
    <div className="w-full aspect-square flex flex-col items-center my-auto justify-center gap-1.5 ">
      {children}
    </div>
  );
};
  ...
  return (
    <motion.div
      ...
      transition={{
        ...
        ease: "easeOut",
        ...(shouldScale
          ? { scale: { delay: 2.7, duration: 0.7, ease: "easeInOut" } }
          : {}),
      }}
    ...
    >
      <CldImage
        ...
        width={500}
        height={500}
        className="w-full h-auto object-cover rounded-lg border-2 border-purple-700/40 shadow-xl"
        sizes="(max-width: 420px) 6vw,
        (max-width: 768px) 10vw,
