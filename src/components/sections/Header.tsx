...
const Header = (props: Props) => {
  ...
  return (
    <section className='w-full aspect-video md:aspect-video lg:aspect-16/8 xl:aspect-16/7 mt-4 flex flex-col items-center justify-center relative top-line bottom-line pattern-bg p-2 '>
