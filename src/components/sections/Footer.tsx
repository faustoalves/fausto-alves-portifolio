...
const Footer = (props: Props) => {
  return (
    ...
    >
      <div className="w-full h-8 bg-linear-to-b from-purple-900/20 to-purple-900/0 absolute top-0 left-0 z-10 border-t border-purple-700/30 dark:border-purple-300/30 dark:from-purple-900/50 dark:to-purple-900/0">
        {" "}
      </div>
