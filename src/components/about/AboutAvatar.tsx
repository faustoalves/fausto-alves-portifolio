...
const AVATAR_3D_URL =
  "https://res.cloudinary.com/faustoalves/image/upload/v1769095321/portifolio/about/me-3d_xtl6oc.png";
const AVATAR_REAL_URL =
  "https://res.cloudinary.com/faustoalves/image/upload/v1769095320/portifolio/about/me-real_ukhgix.png";
...
const AboutAvatar = (props: Props) => {
  return (
    <div className="py-8 md:py-16 lg:py-32 group relative perspective-1000 flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full flex items-center justify-center group-hover:scale-120 scale-130 lg:scale-100 md:group-hover:scale-110 transition-all duration-500 ">
        <svg
          ...
          <g className="textcircle uppercase text-2xl font-bold">
            <text textLength="940" className="text-circle ">
              <textPath
                ...
                textLength="940"
                className="text-circle text-purple-200 dark:text-purple-700 group-hover:text-pink-500 transition-all duration-500 "
              >
